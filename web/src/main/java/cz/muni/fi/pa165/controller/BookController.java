...
public class BookController {
    ...
    public String createBook(@Valid @ModelAttribute("createBook") CreateBookDTO dto, BindingResult result, Model model,
    ...
    public String changeBookState(@PathVariable long id, String state, Model model, UriComponentsBuilder uri) {
